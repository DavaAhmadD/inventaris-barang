    ...
    <div class="wrapper d-flex">
        ...
        <div class="main flex-grow-1">
            ...
            <div class="container mt-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{route ('update-inventaris',['id' => $data->id])}}" method="POST"> @method('PUT')
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="penggunaan" name="penggunaan" value="{{$data->penggunaan}}" required>
                            </div>
                            <div class="mb-3">
